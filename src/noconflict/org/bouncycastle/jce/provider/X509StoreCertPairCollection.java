 ...
 * {@link noconflict.org.bouncycastle.x509.X509Store} SPI implementation for certificate
 * pairs.
 *
 * @see noconflict.org.bouncycastle.x509.X509Store
 * @see noconflict.org.bouncycastle.x509.X509CertificatePair
 */
public class X509StoreCertPairCollection extends X509StoreSpi
{
     ...
     * {@link noconflict.org.bouncycastle.x509.X509CertificatePair}s. The selector must be
     * a {@link noconflict.org.bouncycastle.x509.X509CertPairStoreSelector} to select
     * certificate pairs.
     *
