 ...
 * @see noconflict.org.bouncycastle.crypto.params.AEADParameters
 */
public interface AEADBlockCipher
{
     ...
     * @throws noconflict.org.bouncycastle.crypto.InvalidCipherTextException if the MAC fails to match.
     */
